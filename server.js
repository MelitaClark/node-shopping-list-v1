...
Recipes.create('Tacos', ['avocado', 'beans', 'cilantro', 'rice']);
Recipes.create('Raw PB Cake',['dates','peanut butter', 'walnuts', 'cashews']);
Recipes.create('Kale Soup', ['kale','white beans','vegetable broth', 'onions','garlic']);
